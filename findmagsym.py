...
Linding Yuan, James Rondinelli, Department of Materials Science and Engineering, Northwestern University, Evanston, Illinois  60208, USA
	...
	st.markdown("**Description:** findmagsym is a tool helps to idnetify the magneic space group (with and without spin-orbit coupling) of a magnetic crystal, given the positions and magnetic moments of the atoms in a unit cell.")
